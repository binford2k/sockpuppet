...
Puppet::Indirector::Face.define(:revision, '0.0.1') do
  copyright "Puppet Labs", 2011
  license   "Apache 2 license; see COPYING"

  summary "Returns codebase revision, using config_version."
  ...
  find.default = true
  find.summary "Return codebase revision."
  find.arguments "<dummy_text>"
  find.returns 'The output of config_version'
